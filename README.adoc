...
We were provided with n, e of the public key  and the flag encrypted using this key. We had to try and break this encryption.
...
Kingpin has a system that allows you to dump secrets if you enter the correct pin, however, since the last time, he has hidden the verification mechanisms. Can you figure out how to bypass this?
